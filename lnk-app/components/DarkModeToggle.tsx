...
export default function DarkModeToggle() {
    ...
    return (
        <ThemeContext.Consumer>
            {(value) => (
                <div onClick={toggleDarkMode(value)} className="ml-auto mr-2 flex items-center cursor-pointer">
                    <div className="relative">
                        <input ref={inputRef} defaultChecked={darkMode} type="checkbox" id="dark-mode-toggle" className="sr-only" aria-label="Dark Mode Toggle" />
                        <div className="block bg-gray-600 w-14 h-8 rounded-full">
                        </div>
                        <div className={`${!darkMode && 'transform translate-x-full'} absolute left-1 top-1 bg-white dark:bg-purple w-6 h-6 rounded-full flex items-center justify-center transition-all`}>
                            {!darkMode ? (
                                <svg ref={moonRef} id="moon-icon" viewBox="0 0 97 158" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" strokeWidth="2" className="h-4 ml-1 text-white">
                                ...
                                <svg ref={sunRef} id="sun-icon" viewBox="0 0 170 170" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" fill="currentColor" className="h-4 text-black">
                                    <g id="Group-2" transform="translate(80.000000, 79.000000) rotate(-4.000000) translate(-80.000000, -79.000000) translate(1.000000, -0.000000)">
                                        ...
                                        <g id="Group" strokeLinecap="square" strokeWidth="5" stroke="currentColor">
